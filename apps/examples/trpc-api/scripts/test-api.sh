...
echo -e "\n4. Get Project by ID:"
curl -s -X GET "http://localhost:5000/trpc/project.getProjectById?input=%7B%22id%22%3A%221%22%7D" | jq
...
echo -e "\n7. Get Run by ID:"
curl -s -X GET "http://localhost:5000/trpc/run.getRunById?input=%7B%22id%22%3A%221%22%7D" | jq

echo -e "\n8. Test Error - Invalid Project ID:"
curl -s -X GET "http://localhost:5000/trpc/project.getProjectById?input=%7B%22id%22%3A%22999%22%7D" | jq
